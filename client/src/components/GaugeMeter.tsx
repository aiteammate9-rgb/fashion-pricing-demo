...
export default function GaugeMeter({ score, label, size = 160 }: Props) {
  ...
  const getColor = (s: number) => {
    if (s >= 80) return { stroke: "#0d9488", text: "ขายง่ายมาก", bg: "bg-teal-50", textColor: "text-teal-700" };
    if (s >= 65) return { stroke: "#0d9488", text: "ขายง่าย", bg: "bg-teal-50", textColor: "text-teal-600" };
